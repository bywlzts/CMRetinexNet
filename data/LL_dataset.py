...
class ll_dataset(data.Dataset):
    def __init__(self, opt):
        ...
        self.opt = opt
        self.GT_root, self.LQ_root, self.FR_root, self.FRGT_root = opt['dataroot_GT'], opt['dataroot_LQ'], opt['dataroot_FR'], opt['dataroot_FRGT']

        self.data_info = {'path_LQ': [], 'path_GT': [], 'path_FR': [],'path_FRGT': [], 'folder': [], 'idx': [], 'border': []}
        # Generate data info and cache data
        self.imgs_LQ, self.imgs_GT, self.imgs_FR, self.imgs_FRGT = {}, {}, {}, {}

        subfolders_LQ = util.glob_file_list(self.LQ_root)
        subfolders_GT = util.glob_file_list(self.GT_root)
        subfolders_FR = util.glob_file_list(self.FR_root)
        subfolders_FRGT = util.glob_file_list(self.FRGT_root)

        count = 0
        for subfolder_LQ, subfolder_GT, subfolder_FR, subfolder_FRGT in zip(subfolders_LQ, subfolders_GT, subfolders_FR, subfolders_FRGT):
            subfolder_name = osp.basename(subfolder_LQ)

            img_paths_LQ = [subfolder_LQ]
            img_paths_GT = [subfolder_GT]
            img_paths_FR = [subfolder_FR]
            img_paths_FRGT = [subfolder_FRGT]
            ...
            self.data_info['path_FRGT'].extend(img_paths_FRGT)
            ...
            self.imgs_FRGT[subfolder_name] = img_paths_FRGT
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            img_FRGT = read_img_seq(img_FRGT_path)
            img_LQ = img_LQ[0]
            img_GT = img_GT[0]
            img_FR = img_FR[0]
            img_FRGT = img_FRGT[0]
            ...
            img_FRGT = img_FRGT[:, rnd_h:rnd_h + GT_size, rnd_w:rnd_w + GT_size]
